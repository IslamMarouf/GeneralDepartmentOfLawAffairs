...
namespace GeneralDepartmentOfLawAffairs.UI
{
    public partial class XFrmAddInspection : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void XFrmAddInspection_Load(object sender, EventArgs e) {
            ...
            spInspectionYear.Value = DateTime.Today.Year;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            _subjectsOdbCommand.Parameters.Add("@Subject_id", OleDbType.Char).Value = $"INS-{mtxtInspectionNum.Text}-{spInspectionYear.EditValue}";
            ...
            _subjectsOdbCommand.Parameters.Add("@Subject_year", OleDbType.Char).Value = spInspectionYear.EditValue;
