...
namespace GeneralDepartmentOfLawAffairs
{
    public class RegularNotificationLetter : Letter
    {
        ...
        {
            FrmRegularNotification frmRegular = new FrmRegularNotification();
            _dialogResult = frmRegular.ShowDialog();
            _letterData = frmRegular.FrmLetterData;

            return (_dialogResult == DialogResult.OK) && !frmRegular.FormHasEmptyFields;
        }
