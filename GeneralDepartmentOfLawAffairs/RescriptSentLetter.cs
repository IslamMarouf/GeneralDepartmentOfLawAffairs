...
namespace GeneralDepartmentOfLawAffairs {
    public class RescriptSentLetter : Letter {
        ...
        protected override bool Initialize() {
            FrmRescriptSentLetter frmRescriptSent = new FrmRescriptSentLetter();
            _dialogResult = frmRescriptSent.ShowDialog();
            _letterData = frmRescriptSent.FrmLetterData;

            return (_dialogResult == DialogResult.OK) && !frmRescriptSent.FormHasEmptyFields;
        }
