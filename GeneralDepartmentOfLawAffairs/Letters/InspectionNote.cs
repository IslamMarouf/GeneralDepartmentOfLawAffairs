...
namespace GeneralDepartmentOfLawAffairs.Letters
{
    public class InspectionNote : Letter
    {
        ...
        public InspectionNote(Form form, string subjectId) : base(form, subjectId) {
            KillForm(form);
        ...
        {
            XFrmInspectionNote xFrmInspectionNote = new XFrmInspectionNote();
            xFrmInspectionNote.FrmLetterData.SubjectId = _subjectId;
            _dialogResult = xFrmInspectionNote.ShowDialog();
            _letterData = xFrmInspectionNote.FrmLetterData;
