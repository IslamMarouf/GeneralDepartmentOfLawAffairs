...
namespace GeneralDepartmentOfLawAffairs.Letters {
    public class TableNote : Letter {
        ...
        public TableNote(Form form, string subjectId) : base(form, subjectId) {
            KillForm(form);
        ...
        protected override bool Initialize() {
            ...
            xFrmTableNote.FrmLetterData.SubjectId = _subjectId;
            _dialogResult = xFrmTableNote.ShowDialog();
            _letterData = xFrmTableNote.FrmLetterData;
