...
namespace GeneralDepartmentOfLawAffairs.Letters {
    public abstract class Letter {
        ...
        protected Letter(Form form, string subjectId)
        {
            KillForm(form);
        ...
        protected void KillForm(Form form) {
            form?.Dispose();
        }
        ...
        protected virtual void LetterSections() {
            PreparingLetter();
            HeadingSection();
            DirectionSection();
            BodySection();
        ...
        protected virtual  void PreparingLetter() {
            DocNav.GoToEnd();
        }
