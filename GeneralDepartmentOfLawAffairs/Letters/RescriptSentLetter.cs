...
namespace GeneralDepartmentOfLawAffairs.Letters {
    public class RescriptSentLetter : Letter {
        ...
        public RescriptSentLetter(Form form, string subjectId) : base(form, subjectId) {
            KillForm(form);
        ...
        protected override bool Initialize() {
            ...
            xFrmRescriptSentLetter.FrmLetterData.SubjectId = _caseId;
        ...
        protected override void Register() {
            SubjectsHelper.UpdateCaseProcedure(_caseId,
                ...
                _doc.FullName);
            SubjectsHelper.UpdateSent(_caseId);
        }
    }
}