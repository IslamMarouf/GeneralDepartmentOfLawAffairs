...
namespace GeneralDepartmentOfLawAffairs.Letters {
    public class IssuanceRescriptLetter : Letter {
        ...
        public IssuanceRescriptLetter(Document doc) : base(doc) {
            _doc = doc;
        ...
        public IssuanceRescriptLetter(Form form, string subjectId) : base(form, subjectId) {
            KillForm(form);
        ...
        protected override bool Initialize() {
            ...
            xFrmIssuanceRescriptLetter.FrmLetterData.SubjectId = _caseId;
        ...
        protected override void SentPhotoCopy() {
            ...
            body.GetRange().ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphJustify;

            SignSection();
        }

        protected override void Register() {
            SubjectsHelper.UpdateCaseProcedure(_caseId,
                LetterSentences.APIssuance,
                _doc.FullName);
        }
