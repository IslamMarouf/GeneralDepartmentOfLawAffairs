...
namespace GeneralDepartmentOfLawAffairs.Letters
{
    public class RegularNotificationLetter : Letter
    {
        ...
        public RegularNotificationLetter(Form form, string subjectId) : base(form, subjectId) {
            KillForm(form);
        ...
        protected override bool Initialize()
        {
            ...
            xFrmRegular.FrmLetterData.SubjectId = _subjectId;
        ...
        protected override void Register() {
            SubjectsHelper.UpdateNotification(
                _subjectId,
