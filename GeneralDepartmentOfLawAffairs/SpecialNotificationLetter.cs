...
namespace GeneralDepartmentOfLawAffairs
{
    public class SpecialNotificationLetter : Letter
    {
        ...
        public SpecialNotificationLetter(Word.Document doc) : base(doc)
        {
            _doc = doc;
        }
        ...
        {
            FrmSpecialNotification frmSpecial = new FrmSpecialNotification();
            _dialogResult = frmSpecial.ShowDialog();
            _letterData = frmSpecial.FrmLetterData;

            return (_dialogResult == DialogResult.OK) && !frmSpecial.FormHasEmptyFeilds;
        }
        ...
        protected override void BodySection()
        {
            ...
            string reqStr = _letterData.WantedNamesList[0] + " " + _letterData.WantedDocuments;
        ...
        protected override void RequestSection()
        {
            ...
            requestParagraph.AddFormatted(str, "times new roman", 12, false);
            ...
            requestParagraph.FormattedSentence(_letterData.InvestigationNumber, "pt bold heading", 11);
