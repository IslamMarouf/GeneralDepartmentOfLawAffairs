        ...
        */
        ...
        private void MainInterface_Load(object sender, RibbonUIEventArgs e) {
            ...
            var invNotification = from na in _ds.Tables["tblSubjects"].AsEnumerable()
                ...
                where na.Field<DateTime?>("Subject_procedureDate") <= DateTime.Today.AddDays(-2) && na.Field<DateTime?>("subject_procedureOutComDate").Equals(null) 
            ...
            var invInquiry = from ia in _ds.Tables["tblSubjects"].AsEnumerable()
                ...
                where ia.Field<DateTime?>("Subject_procedureDate") <= DateTime.Today.AddDays(-2) && ia.Field<DateTime?>("subject_procedureOutComDate").Equals(null)
            ...
            foreach (var ca in caseAdd) {CaseQueryResultItem(ca, QueryFormType.CaseProc);
            }
