    ...
    class MissionLetter : Letter {
            ...
            for (var i = 1; i <= rowsCount; i++) {
                for (var j = 1; j <= columnsCount; j++) {
                    ...
                    /*
                        ...
                        TableParagraph(c, "12345", "PT Bold Heading", 10);
                        c.Range.Font.Hidden = 0;
                    } */
        ...
        protected override void SignSection() {
            ...
            Microsoft.Office.Tools.Word.Document vstoDocument =
                ...
                Microsoft.Office.Tools.Word.Bookmark firstParagraph = vstoDocument.Controls.AddBookmark(
                vstoDocument.Paragraphs[1].Range, "FirstParagraph");


            Find f = _doc.Range().Find;
            f.Text = "12345";
            f.MatchWholeWord = false;

            if (f.Execute()) {
                _doc.Range().Information[WdInformation.wdActiveEndPageNumber].ToString();
