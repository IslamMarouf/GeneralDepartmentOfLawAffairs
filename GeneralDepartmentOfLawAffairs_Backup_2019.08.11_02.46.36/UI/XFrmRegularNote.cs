...
{
    public partial class XFrmRegularNote : DevExpress.XtraEditors.XtraForm
    {
        ...
        */
        ...
        private void XFrmRegularNote_Load(object sender, EventArgs e) {
            dflRegularNote.LookAndFeel.SkinName = Settings.Default.CurrentSkinName;
        ...
        private void cmbCDept_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void XFrmRegularNote_FormClosing(object sender, FormClosingEventArgs e)
        {
